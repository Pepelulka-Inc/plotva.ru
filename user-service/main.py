...
from app.dtos.user.user_dtos import UpdateUserDTO, CreateUserDTO
from app.use_cases.user.update_info import UpdateUserUseCase
...
async def get_uow(app: web.Application) -> UnitOfWork:
    return UnitOfWork(session_factory=app["session_factory"])
